...
#ifndef SWIFTMAUI_SWIFT_H
#define SWIFTMAUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftMaui",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP9SwiftMaui10UIViewHost_")
@protocol UIViewHost
...
SWIFT_CLASS("_TtC9SwiftMaui13MyTextWrapper")
